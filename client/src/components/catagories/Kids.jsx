...
const Kids = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/products/category/Kids")
      .then((response) => {
  ...
  return (
    <div className="p-10 text-center">
      ...
      <p className="text-gray-600 mt-2">Discover cutest outfits for kids.</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        {products.length > 0 ? (
          ...
          <p className="text-gray-500 mt-4">❌ No kids products available.</p>
        )}
      </div>
    </div>
  );
