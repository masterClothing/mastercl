...
const Trending = () => {
  ...
  // State to toggle between 6 items vs. all items
  ...
  // Decide which items to display: 6 or all
  const displayedItems = showAll ? items : items.slice(0, 8);

  // Toggle function to switch between showing all or just 6
  const toggleShowAll = () => {
  ...
  return (
    <div>
      <div className="font-sans p-4 mx-auto lg:max-w-6xl md:max-w-3xl">
        ...
        {/* If there's more than 6 items, show the toggle button */}
        {items.length > 6 && (
